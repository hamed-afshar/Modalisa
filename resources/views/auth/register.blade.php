            ...
            <form method="POST" action="{{ route('users.store')}}" class="bg-white shadow-md rounded px-8 py-8">
                ...
                <div class="flex flex-wrap mb-6 mt-6">
                    ...
                    <div class="w-full lg:w-2/3">
                        <input class="input-text w-full"
                               type="text" id="name" name="name" value="{{ old('name') }}" autocomplete="name" autofocus placeholder="Alex Morgan" required>
                    </div>
                    @error('name')
                ...
                <div class="flex flex-wrap mb-6">
                    ...
                    <div class="w-full lg:w-2/3">
                        <input class="input-text w-full" type="email" id="email" name="email"
                               value="{{ old('email') }}" autocomplete="email" placeholder="name@example.com" required>
                    </div>
                    @error('email')
                    <div class="error"> {{ $message }}</div>
                    @enderror
                ...
                <div class="flex flex-wrap mb-6">
                    ...
                    <div class="w-full lg:w-2/3">
                        <select
                                class="input-option w-full"
                                id="communication_media" name="communication_media" value="{{ old("communication_media") }}" required>
