<template>
	<div>
		<header class="container flex bg-white bg-pink-800 text-white font-bold justify-center border rounded-lg mt-4 py-2 mx-auto w-full">
			{{ $t('translate.system_admin_dashboard') }}
		</header>
		<div class="mt-4">
